...
FROM usdotfhwastol/autoware.ai:release-demo AS source-code
...
FROM usdotfhwastol/autoware.ai:release-demo AS install
...
FROM usdotfhwastol/autoware.ai:release-demo
