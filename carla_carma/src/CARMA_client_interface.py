...
from beginner_tutorials.msg import ExternalObjectList, CarlaEgoVehicleControl, RobotEnabled, CarlaEnabled 
from beginner_tutorials.msg import ExternalObject, CarmaInit
...
def receive_init_message_from_CARMA():
    ...
    #data = rospy.wait_for_message('Robot_Enabled_Topic', Bool) 
...
pub_ce=rospy.Publisher('Robot_Enabled_Topic',RobotEnabled,queue_size=1)
